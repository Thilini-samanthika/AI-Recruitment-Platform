...
public class OpenApiConfig {
    ...
    public OpenAPI companyServiceOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("AI Recruitment Platform - Company Service API")
                        .version("1.0.0")
                        .description("Microservice responsible for corporate employer registration, profile management, and corporate identity.")
                        .contact(new Contact()
                                .name("Member 3 (Company Service Lead)")
