...
public class OpenApiConfig {
    ...
    public OpenAPI jobServiceOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("AI Recruitment Platform - Job Service API")
                        .version("1.0.0")
                        .description("Microservice responsible for job postings, vacancy search, candidate applications, and application lifecycle management.")
                        .contact(new Contact()
                                .name("Member 4 (Job Service Lead)")
